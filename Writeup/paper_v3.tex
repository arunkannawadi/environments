...
tricky\claire{highlight, I'd use a different word only because I think tricky is too informal. Unless the journal complains, its a personal taste thing. } because both distributions have hard cutoffs that are enforced
...
dominant in its size, the combination with (\claire{of} \arun{I guess this was meant to say COSMOS + other surveys?} \claire{how about this: However, as COSMOS is significantly larger than other \emph{HST} surveys, combining COSMOS with smaller fields is unlikely to ameliorate this effect.} )other much smaller fields
