...
But from Fig.~\ref{fig:median_sersicn} and Fig.~\ref{fig:median_dvcbtt}, it doesn't appear to be the case. 
...
But in reality, it consists of an unusual morphological mixture and the situation can be more complicated. 
