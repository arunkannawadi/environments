...
is 5 per cent \rachel{(absolute, not relative)} for redshift bins of width $\Delta z=0.05$, which could result in uncertain shear calibration at the 1 per cent level. We conclude that the cosmic variance effects are large enough to exceed the systematic error budget of future surveys, but can be mitigated with careful choice of training dataset and sufficiently large redshift binning.
\end{abstract}
...
matter power spectrum \rachel{\citep[e.g.,][]{2011MNRAS.415.3649V,2011MNRAS.417.2020S}}, as well as observational uncertainties such as
...
\rachel{Finally, we comment on whether the trends we
...
\rachel{As a test of the second option, we consider whether we can use some division of the
...
\begin{figure}
 ...
 \caption{\rachel{The fraction of galaxies in \s1 (open symbols) and
...
\rachel{Fig.~\ref{fig:rmsellip_bulge_disk} shows the RMS distortion as
...
\begin{figure}
 ...
 \caption{\rachel{The RMS distortion as a function of redshift for the
...
\rachel{The estimates in this subsection are rough illustrations of
  ...
  gradients as a function of galaxy type\footnote{\rachel{\cite{2012MNRAS.421.1385V} showed that the
  ...
  \rachel{The presence of other fields besides AEGIS (e.g., GOODS)
    ...
    by a small number of them\footnote{\rachel{For context,
        \cite{2015APh....63...81N} 
...
\subsection{\rachel{Effective impact on current and future surveys}}
...
\rachel{Finally, our results for the effect on the intrinsic
...
\rachel{factor of 9 (for AEGIS, and more for GOODS).  The GEMS field
...
important to take into account.  \rachel{It would also be advisable to
