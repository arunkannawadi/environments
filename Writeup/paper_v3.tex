...
Such a trend is also observed in axis ratios based on second moments.\arun{I've commented on the agreement/disagreement of the distributions themselves in Table~\ref{table:pvalues_momentbased_all}. No plots included.} 
...
\begin{equation}
 ...
 \label{eq:distortion}
\end{equation}
\arun{Is this the correct denominator?}
