...
entire redshift range. \arun{weighted by the number fraction in each bin.} % If a model and the distribution agree, then $\delta_{g,\text{1D}}=0$ for that model at all the redshifts. 
...
\begin{figure}
 \centering
 \includegraphics[width=1.0\columnwidth]{rms_ellip2_noevolution_wide} \
 \includegraphics[width=1.0\columnwidth]{rms_ellip2_Bbandevolution_wide}
 \caption{ RMS ellipticities as a function of redshift. The horizontal errorbars indicate
