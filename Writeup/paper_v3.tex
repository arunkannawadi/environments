...
In Figs.~\ref{fig:median_sersicn}, we see that the \sersic indices of mass selected sample (\s$3$) are systematically greater than those of the luminosity selected samples (\s$1$,\s$2$).
