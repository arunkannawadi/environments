...
Using X-ray information in the COSMOS field, \cite{COSMOS_XRAY} have detected a galaxy group in the
redshift range $z=0.425-0.575$.} \rachel{I thought it was more than one galaxy group there?}
