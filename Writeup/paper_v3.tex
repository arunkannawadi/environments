...
In Figs.~\ref{fig:rms_ellip}--\ref{fig:median_dvcbtt}, this does not always appear to be the case. 
...
To eliminate the possibility (with great confidence) that this varying sample size is 
