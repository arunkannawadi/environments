...
conclusion that it is underdense. \arun{New:}The naive Poisson uncertainty of the counts
...
See Fig.~\ref{fig:redshift_vollimited_wide}. Thus, as before, we classify $\left[ 0.7 - 0.85\right]$ bin as `neutral'.
