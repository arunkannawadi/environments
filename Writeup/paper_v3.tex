...
Wide-Field Infrared Survey Telescope~\citep[WFIRST;][]{WFIRST_AFTA_FINAL}
...
%  generating one.}
We generate, using the method below, a volume-limited sample that is complete upto $z=1$ by applying a cut on luminosity such that only galaxies instrinsically brighter than a certain threshold is considered. This threshold is set on $K$-corrected $F814W$-band magnitudes, denoted as $M_I$.
