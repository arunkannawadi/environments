...
\begin{figure}
 \centering
  \includegraphics[width=\columnwidth]{redshift_fluxlimited_withcoil}
...
\begin{figure}
 \centering
  \includegraphics[width=\columnwidth]{redshift_vollimited_withcoil}
  \caption{
...
evolution across the $z>0.5$ \arun{$z<0.5$, you mean?} range.  
...
Next, we show an analogous plot of RMS ellipticities \arun{Is this ellipticity or distortion?} for all three
...
The KS and AD statistical tests are both sensitive to exactly what happens at these hard boundaries in the distributions.
...
$\left[ 0.5 - 0.7\right]$ and $\left[ 0.7 - 0.85\right]$.
\begin{figure}
 \centering
...
range of values they assume have become smaller and so have the vertical errorbars, due to the increase in the number of galaxies in each redshift bin. The results do not suggest that statistic values
