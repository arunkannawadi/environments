...
(\s$1$, \s$2$).  
This is because \s3 is restricted to galaxies with masses above $\log(M/M_\odot) > 10.15$, whereas in \s1 and \s2, the mass distribution of the galaxies extends to $\log(M/M_\odot) \sim 9.0$.
