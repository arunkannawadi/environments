...
other {\em HST} fields such as GOODS and AEGIS lagging by at least a
\rachel{factor of 6 (for GEMS, more for AEGIS and GOODS)}.  Hence, if cosmic variance due to structures along
