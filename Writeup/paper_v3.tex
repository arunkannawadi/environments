...
\begin{figure}
  \centering
   ...
   \caption{2D histogram of galaxies in apparent magnitude
     ($m_\text{F814W}$) and absolute magnitude ($M_I$). \rachel{What
       redshift range?}}
   \label{fig:2Dhist}
\end{figure}
...
\begin{figure}
  \centering
   ...
   \caption{Distribution of absolute magnitude $M_I$ for various
     flux-limited samples are plotted together. The vertical line
   ...
   \rachel{Is this plot and the numbers in the caption for
     ...
     this.  If that is wrong, then please fix the text.}}
   \label{fig:MIhist}
 \end{figure}
...
definitions of volume-limited samples. (\rachel{Do the numbers in the
  table include the full sample or just the subsample with postage stamps?}) However, in the rest of this
paper, we analyse only those galaxies for which there are postage stamp
