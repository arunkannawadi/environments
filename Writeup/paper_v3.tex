...
likely limited to higher mass galaxies overall.  It is therefore (\claire{Can't you show the masses are higher? No need to hedge.} \arun{I am not sure what you want me to show here.}) not
...
Shifting the bins enhances the overdensities and underdensities in some cases and in other cases, it mixes the overdense and underdense regions to make it more neutral-like. 
The environmental trends are observed in the enhanced bins and hence our conclusions are still applicable. 
...
RMS ellipticity at the level of 0.01 (Figs.~\ref{fig:rms_ellip} and~\ref{fig:rms_ellip_momentbased})(\claire{That's the level you find, correct?} \rachel{Yes, perhaps we should reference a figure when we mention this so that it's clear where 0.01 comes from.} \arun{Referring both figures is fine?}) would become fractional shear
errors of
\begin{equation}
