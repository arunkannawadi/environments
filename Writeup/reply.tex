...
\cnl{I'm almost certain it has to be plain text, one for the editor and one for the author.}
...
In addition to the above changes, we made a few minor modifications that are not in response to the referee's comments. \\
